...
export const INITIAL_PROPERTIES: Property[] = [
  {
    ...
    tempoAteTrabalhoMinutos: 27,
    tempoSaymonMinutos: 44,
    tempoKellyMinutos: 10,
  ...
  },
  {
    ...
    tempoAteTrabalhoMinutos: 30,
    tempoSaymonMinutos: 44,
    tempoKellyMinutos: 16,
  ...
  {
    id: 'prop-gerdimoveis-11ca03d8452c457',
    titulo: 'Edifício Residencial Yara',
    urlAnuncio: 'https://app.imoview.com.br/url/short/gerdimoveis/11ca03d8452c457',
    urlImagem: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1200&q=80',
    bairro: 'Vila Yara - Osasco',
    endereco: 'Av. Franz Voegeli, 300 - Vila Yara',
    valorAluguel: 5200,
    valorCondominio: 1100,
    valorIptu: 200,
    valorSeguroIncendio: 34.29,
    custoTotalMensal: 6534.29,
    dormitorios: 3,
    suites: 1,
    banheiros: 2,
    vagasGaragem: 2,
    areaUtil: 84,
    precoMetroQuadrado: 77.79,
    tempoAteTrabalhoMinutos: 27,
    tempoSaymonMinutos: 44,
    tempoKellyMinutos: 10,
    ...
    observacoes: 'Gerd Imóveis. Aluguel R$ 5.200 + Cond R$ 1.100 + IPTU R$ 200 + Seguro Incêndio R$ 34,29/mês.',
    duvidasCorretor: '1. O seguro incêndio é de R$ 34,29 por mês?\n2. Condomínio inclui água/gás?',
    dataCadastro: '2026-08-21T01:30:00.000Z',
    isFavorito: false,
  },
];
